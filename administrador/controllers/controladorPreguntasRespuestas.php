<?php
require_once __DIR__ . '/../models/modeloRespuesta.php';
require_once __DIR__ . '/../models/modeloPregunta.php';

class controladorPreguntasRespuestas{
    ...
    public function mostrarCreacion(){
        $this->vista = 'creación_Preguntas.html';
        return true;
    }
