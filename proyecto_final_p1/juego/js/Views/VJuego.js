export class VJuego {
    constructor() {
        ...
        if(localStorage.getItem('puntosJugador') !== null){
            this.puntosJugador = parseInt(localStorage.getItem('puntosJugador'));
        } else {
    ...
    mostrarPreguntas(arrayPreguntas) {
        ...
        if (arrayPreguntas.length > 0) {
            ...
            localStorage.setItem('puntosPregunta', pregunta.puntos || '10'); // Guarda puntos de la pregunta
    ...
    accionRespuestas(event) {
        ...
        const puntosPregunta = parseInt(localStorage.getItem('puntosPregunta')) || 10;
        const puntosObtenidos = esCorrecta ? puntosPregunta : 0;
