export class ModificarPreguntasRespuestas {
    constructor(controlador) {
       ...
       // this.visualizarDatos();
        ...
        // Eliminamos el DOMContentLoaded con el fetch manual. 
        // Confiamos en que el controlador haga el trabajo.
    ...
    visualizarDatos(datos) {
        ...
        if (respuestas && respuestas.length > 0) {
            respuestas.forEach((respuesta, index) => {
                ...
                // PHP envía '1' o true. A veces llega como string "1".
