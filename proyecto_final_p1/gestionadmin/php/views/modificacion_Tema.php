...
<body id="modificacionTemas">
    ...
    <main>
        ...
        <div class="container">
            ...
            <a href="php/index.php?action=eliminarTema&controller=Temas&idTema=<?=$tema['idTema']?>">Eliminar Tema</a>
        </div>
                ...
                <?php
                    if (!empty($preguntas)) {
                        foreach ($preguntas as $preg) {
                            ...
                            echo '<a class="tema-link" href="./index.php?controller=PreguntasRespuestas&action=vistaEditarPregunta&idTema=' . $tema['idTema'] . '&nPregunta=' . $preg['nPregunta'] . '">';
                            echo $preg['titulo'];
                            echo '</a>';
                            echo '<a href="./index.php?controller=PreguntasRespuestas&action=borrarPregunta&idTema=' . $tema['idTema'] . '&nPregunta=' . $preg['nPregunta'] . '">';
                            echo '<button id="delete-btn" type="button">🗑️</button>';
                            echo '</a>';
                            echo '</div>';
                        }
                    } else {
