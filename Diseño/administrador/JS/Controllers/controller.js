        ...
        formularioPrincipal.addEventListener("submit", (evento) => {
            ...
            if (inputClaveNueva && inputClaveConfirmar) {
                ...
                if (formularioValido) {
                    ...
                    window.location.href = "/diseño/Mockups/administrador/panelAdministrador.html";
                }
                return;
            }
            ...
            if (inputCorreo && inputPassword) {
                ...
                if (loginValido) {
                    window.location.href = "/diseño/Mockups/administrador/modificarContraseña.html";
                }
            }
        });
    }
    ...
    botonesBorrar.forEach(boton => {
        boton.addEventListener("click", (evento) => {
            ...
            if (Vista.confirmarBorrado()) {
                window.location.href ="./gestiontemas.html";
            }
        });
    });
