...
<body>
    ...
    <main>
        ...
        <div class="container">
            <h3>Editar Tema</h3>
            <form action="index.php?action=modificarTemas&controller=Temas&idTema=<?php echo $datos['idTema']; ?>" method="post">
                <div class="form-box">
            ...
            <a href="index.php?action=eliminarTema&controller=Temas&idTema=<?php echo $datos['idTema']; ?>">Eliminar Tema</a>
        </div>
